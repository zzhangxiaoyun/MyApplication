 ...
 * @functionModule
 */
public class EndAnimaSet extends AnimationSet {
    /**
     *
    ...
    public EndAnimaSet(float transDistance, float toScaleXy) {
        super(false);
        ...
        ScaleAnimation scaleAnimation = new ScaleAnimation(1f,toScaleXy,1f,toScaleXy, Animation.RELATIVE_TO_SELF,0.5f,Animation.RELATIVE_TO_SELF,1f);
